...
class AzureConfigurationClientImp(object):
    ...
    def get_key_values(
        ...
        return deserialized
    get_key_values.metadata = {'url': '/kv/{key}'}

    def create_or_update_key_values(
        ...
        """
        # Construct URL
        url = self.create_or_update_key_values.metadata['url']
        path_format_arguments = {
            'key': self._serialize.url("key", key, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_or_update_key_values.metadata = {'url': '/kv/{key}'}
    ...
    def delete_key_values(
        ...
        """
        # Construct URL
        url = self.delete_key_values.metadata['url']
        path_format_arguments = {
            'key': self._serialize.url("key", key, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    delete_key_values.metadata = {'url': '/kv/{key}'}
    ...
    def create_locks(
        ...
        """
        # Construct URL
        url = self.create_locks.metadata['url']
        path_format_arguments = {
            'key': self._serialize.url("key", key, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    create_locks.metadata = {'url': '/locks/{key}'}
    ...
    def delete_locks(
        ...
        """
        # Construct URL
        url = self.delete_locks.metadata['url']
        path_format_arguments = {
            'key': self._serialize.url("key", key, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    delete_locks.metadata = {'url': '/locks/{key}'}
